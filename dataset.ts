const dataset = {
    ...
    /* Reels structure description:
       It should contain
       Columns: 5
       Rows: 3
       Standard 5 lines slot game
    */
    reelsCount: 5,
    rowsCount: 3,
  

    /* Symbols object description:
    Example:
      Symbol "1" Reward Map:
        1 consecutive meets: 0$ reward
        2 consecutive meets: 0$ reward
        3 consecutive meets: 10$ reward
        4 consecutive meets: 20$ reward
        5 consecutive meets: 50$ reward
    */
    symbols: {
      1: [0, 0, 10, 20, 50],
      2: [0, 0, 20, 40, 100],
    ...
    */
    ...
    /* Reels datafill set 
      Simplified description: Symbol placement datamap.
    */
